  ...
  return (
    <div className="py-10">
        ...
        {product.images.map((image, idx) => (
          ...
          >
            <Image
              ...
              height={1000}
              width={1000}
              className="h-14 w-16 md:h-40 md:w-60 object-cover object-top mr-4 border rounded-lg border-neutral-100"
            />
          </button>
        ))}
      </div>
      ...
      <div className="prose prose-sm md:prose-base max-w-none text-neutral-600">
        <p>{locale === "en" ? product?.content_en : product?.content_ar}</p>
      </div>
      ...
      >
        {locale === "en" ? "Live Preview" : "المعاينة المباشرة"}
        <svg
